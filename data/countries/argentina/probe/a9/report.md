...
País: **argentina** · calibración: **a9_clean** · semillas: **10** (desde 1) · transiciones de régimen: **sí** · 15.4 s
...
|---|---|---:|---:|---|---|---:|---:|
| `1983-12` | 1983-12 | 72 | **10** | 9–14 | `hyperinflation` 10 | 10 | 0 |
| `1991-04` | 1991-04 | 120 | **96** | 88–102 | `hyperinflation` 10 | 12 | 0 |
...
Semillas usables: **10**. Outcomes: `hyperinflation` 10.
...
|---|---|---:|---:|---:|---:|
| `social_tension` | hi = 100 | 10/10 | 4.0 | 5.5 | 53 % |
| `institutional_confidence` | lo = 0 | 10/10 | 7.0 | 4.5 | 45 % |
| `crime_perception` | hi = 100 | 10/10 | 8.0 | 4.0 | 40 % |
| `government_approval` | lo = 0 | 10/10 | 2.0 | 4.0 | 33 % |
| `political_stability` | hi = 100 | 6/10 | 9.0 | 2.5 | 25 % |
| `real_wage` | hi = 200 | 6/10 | 10.0 | 2.0 | 17 % |
| `consumer_confidence` | lo = 0 | 1/10 | 9.0 | 1.0 | 11 % |
| `reserves` | lo = 0 | 7/10 | 9.0 | 1.0 | 11 % |
| `protest_level` | hi = 100 | 1/10 | 5.0 | 1.0 | 8 % |
| `interest_rate` | hi = 300 | 1/10 | 14.0 | 1.0 | 7 % |
...
| `hyperinflation` | 10/10 | 10.0 |
| `agreement_honored:gov_caba:restore_transfers` | 4/10 | 4.0 |
| `agreement_honored:gov_cordoba:restore_transfers` | 3/10 | 4.0 |
| `agreement_honored:gov_mendoza:restore_transfers` | 2/10 | 5.5 |
| `agreement_honored:gov_rio_negro:restore_transfers` | 2/10 | 7.0 |
...
| variable | cota | semillas | 1er mes (mediana) | meses pegada (mediana) | % de la corrida |
|---|---|---:|---:|---:|---:|
| `institutional_confidence` | lo = 0 | 10/10 | 17.5 | 79.5 | 83 % |
| `political_stability` | hi = 100 | 10/10 | 1.0 | 75.5 | 82 % |
| `real_wage` | hi = 200 | 10/10 | 20.0 | 76.0 | 79 % |
| `government_approval` | hi = 100 | 10/10 | 27.0 | 67.0 | 70 % |
| `social_tension` | lo = 0 | 10/10 | 39.5 | 54.5 | 56 % |
| `protest_level` | lo = 0 | 10/10 | 30.0 | 50.0 | 51 % |
| `poverty` | lo = 0 | 10/10 | 48.5 | 46.5 | 48 % |
| `inequality` | lo = 20 | 10/10 | 49.0 | 46.0 | 48 % |
| `unemployment` | lo = 2 | 10/10 | 65.0 | 30.5 | 32 % |
| `crime_perception` | hi = 100 | 10/10 | 10.0 | 16.0 | 17 % |
| `exchange_rate` | hi = 1e+06 | 10/10 | 79.5 | 16.5 | 17 % |
