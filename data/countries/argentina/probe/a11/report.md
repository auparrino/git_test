...
País: **argentina** · calibración: **a9_clean** · semillas: **10** (desde 1) · transiciones de régimen: **sí** · 17.8 s
...
| `1991-04` | 1991-04 | 120 | **120** | 120–120 | `survived` 10 | 14 | 0 |
...
| `government_approval` | hi = 100 | 10/10 | 13.0 | 59.0 | 82 % |
| `interest_rate` | hi = 300 | 10/10 | 16.0 | 57.0 | 79 % |
| `exchange_rate` | hi = 1e+06 | 10/10 | 35.5 | 37.5 | 52 % |
| `poverty` | lo = 0 | 10/10 | 38.0 | 35.0 | 49 % |
| `consumer_confidence` | lo = 0 | 9/10 | 34.0 | 27.0 | 38 % |
| `inequality` | lo = 20 | 10/10 | 49.0 | 24.0 | 33 % |
| `protest_level` | lo = 0 | 10/10 | 32.0 | 19.5 | 27 % |
| `crime_perception` | hi = 100 | 10/10 | 8.0 | 15.0 | 21 % |
| `social_tension` | lo = 0 | 10/10 | 22.5 | 7.5 | 10 % |
| `reserves` | lo = 0 | 10/10 | 11.0 | 6.0 | 8 % |
...
| `agreement_honored:gov_caba:restore_transfers` | 9/10 | 11.0 |
...
| variable | cota | semillas | 1er mes (mediana) | meses pegada (mediana) | % de la corrida |
|---|---|---:|---:|---:|---:|
| `institutional_confidence` | lo = 0 | 10/10 | 18.0 | 103.0 | 86 % |
| `political_stability` | hi = 100 | 10/10 | 1.0 | 102.0 | 85 % |
| `real_wage` | hi = 200 | 10/10 | 22.5 | 98.5 | 82 % |
| `government_approval` | hi = 100 | 10/10 | 30.0 | 89.0 | 74 % |
| `social_tension` | lo = 0 | 10/10 | 41.0 | 77.5 | 65 % |
| `inequality` | lo = 20 | 10/10 | 51.0 | 70.0 | 58 % |
| `poverty` | lo = 0 | 10/10 | 51.0 | 70.0 | 58 % |
| `protest_level` | lo = 0 | 10/10 | 31.0 | 66.0 | 55 % |
| `unemployment` | lo = 2 | 10/10 | 65.5 | 51.5 | 43 % |
| `exchange_rate` | hi = 1e+06 | 10/10 | 82.5 | 38.5 | 32 % |
| `crime_perception` | hi = 100 | 10/10 | 11.0 | 16.5 | 14 % |
| `interest_rate` | hi = 300 | 6/10 | 113.5 | 7.5 | 6 % |
| `gdp` | hi = 400 | 1/10 | 117.0 | 4.0 | 3 % |
| `reserves` | lo = 0 | 3/10 | 22.0 | 1.0 | 1 % |
...
| `agreement_honored:gov_buenos_aires:restore_transfers` | 10/10 | 2.0 |
| `agreement_honored:biz_agro:tax_exemption` | 10/10 | 4.0 |
| `agreement_honored:gov_cordoba:restore_transfers` | 10/10 | 5.0 |
| `fx_regime_exit` | 10/10 | 8.0 |
| `fx_vector_switch:float` | 10/10 | 9.0 |
| `agreement_honored:gov_caba:restore_transfers` | 10/10 | 20.0 |
| `agreement_honored:gov_rio_negro:restore_transfers` | 10/10 | 24.0 |
| `election:ucr` | 10/10 | 72.0 |
| `term_end:survived` | 10/10 | 120.0 |
| `forced_devaluation` | 9/10 | 18.0 |
...
| variable | cota | semillas | 1er mes (mediana) | meses pegada (mediana) | % de la corrida |
|---|---|---:|---:|---:|---:|
| `crime_perception` | hi = 100 | 10/10 | 13.0 | 31.0 | 52 % |
...
| `agreement_honored:gov_rio_negro:restore_transfers` | 9/10 | 17.0 |
